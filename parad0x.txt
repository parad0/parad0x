...
start:              ; start label from where our code starts
    ...
    start_os_intro db 'parad0x OS - v0.0.1 (BETA)',0
    press_key db '[!] Press Enter to continue [!]',0

    login_username db 'Username : ',0
    login_password db 'Password : ',0
    
    display_text db '[+] You have successfully logged in', 0

    os_info db 10, 'parad0x OS - 16-BIT - Version: 0.0.1 ~ (BETA - unreleased)',13,0

    press_key_2 db 10,'Press Enter to view Graphics',0
